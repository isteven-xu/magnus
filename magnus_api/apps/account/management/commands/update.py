...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # update web
        web_dir = os.path.join(settings.BASE_DIR, '../magnus_web')
        commands = [
            f'curl -o /tmp/magnus_web.tar.gz https://cdn.magnus.cc/magnus/web_{version}.tar.gz',
            f'rm -rf {web_dir}/build',
            f'tar xf /tmp/magnus_web.tar.gz -C {web_dir}'
        ]
