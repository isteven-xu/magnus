...
import logo from 'layout/logo-magnus-txt.png';
        ...
        if (data['required_mfa']) {
          ...
          Modal.warning({
            ...
            content: <div>
              ...
              {/*<a target="_blank"*/}
              {/*   href="https://magnus.cc/docs/practice/"*/}
  ...
  return (
    <div className={styles.container}>
      <div className={styles.titleContainer}>
        ...
        <div className={styles.desc}>浙里信大数据集群管理平台</div>
      </div>
      ...
      <div className={styles.footerZone}>
        ...
        {/*  <a className={styles.links} title="官网" href="https://magnus.cc" target="_blank"*/}
        {/*     rel="noopener noreferrer">官网</a>*/}
        {/*  <a className={styles.links} title="Github" href="https://github.com/openmagnus/magnus" target="_blank"*/}
        {/*     rel="noopener noreferrer"><GithubOutlined/></a>*/}
        {/*  <a title="文档" href="https://magnus.cc/docs/about-magnus/" target="_blank"*/}
        {/*     rel="noopener noreferrer">文档</a>*/}
        {/*</div>*/}
        <div style={{color: 'rgba(0, 0, 0, .45)'}}>Copyright <CopyrightOutlined/> {new Date().getFullYear()} By 浙里信</div>
      </div>
    </div>
  )
}
