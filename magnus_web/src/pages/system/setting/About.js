...
class About extends React.Component {
  ...
  componentDidMount() {
    ...
    http.get(`https://api.magnus.cc/apis/release/latest/?version=${VERSION}`)
      .then(res => {
        if (res.has_new) {
          notification.open({
            key: 'new_version',
            ...
            icon: <SmileTwoTone/>,
            btn: <a target="_blank" rel="noopener noreferrer" href="https://magnus.cc/docs/update-version/">如何升级？</a>,
      ...
      <Spin spinning={fetching}>
        ...
        <Descriptions column={1}>
          ...
          <Descriptions.Item label="更新日志">
            <a href="https://magnus.cc/docs/change-log/" target="_blank"
               rel="noopener noreferrer">https://magnus.cc/docs/change-log/</a>
          </Descriptions.Item>
        </Descriptions>
