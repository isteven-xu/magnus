...
export default observer(function () {
  ...
  function handleChangeMFA(v) {
    if (v && !store.settings.magnus_key) return message.error('开启MFA认证需要先在基本设置中配置调用凭据');
  ...
  return (
    <React.Fragment>
      ...
      <Form layout="vertical" style={{maxWidth: 500}}>
        <Form.Item
          label="访问IP校验"
          extra={<span>建议开启，校验是否获取了真实的访问者IP，防止因为增加的反向代理层导致基于IP的安全策略失效，当校验失败时会在登录时弹窗提醒。如果你在内网部署且仅在内网使用可以关闭该特性。
            {/*<a*/}
            {/*href="https://magnus.cc/docs/practice"*/}
            {/*target="_blank" rel="noopener noreferrer">为什么没有获取到真实IP？</a>*/}
        </span>}>
          <Switch
            checkedChildren="开启"
        ...
        {/*      target="_blank" rel="noopener noreferrer" href="https://magnus.cc/docs/wx-token/">什么是微信Token？</a></span>}>*/}
        {/*  {visible ? (*/}
