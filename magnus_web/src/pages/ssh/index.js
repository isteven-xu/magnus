...
function WebSSH(props) {
  ...
  const magnus_web_terminal =
  '   __  ______  ______  ____  ______  _      _________    _____________  __  ________  _____   __ \n' +
      '  /  |/  / _ |/ ___/ |/ / / / / __/ | | /| / / __/ _ )  /_  __/ __/ _ \\/  |/  /  _/ |/ / _ | / / \n' +
      ' / /|_/ / __ / (_ /    / /_/ /\\ \\   | |/ |/ / _// _  |   / / / _// , _/ /|_/ // //    / __ |/ /__\n' +
      '/_/  /_/_/ |_\\___/_/|_/\\____/___/   |__/|__/___/____/   /_/ /___/_/|_/_/  /_/___/_/|_/_/ |_/____/\n' +
      '                                                                                                 '
  ...
  return hasPermission('host.console.view|host.console.list') ? (
    <div className={styles.container} onMouseUp={() => posX = 0} onMouseMove={handleMouseMove}>
      ...
      <div className={styles.content}>
        ...
        {hosts.length === 0 && (
          <pre className={sshMode ? styles.fig : styles.fig2}>{magnus_web_terminal}</pre>
        )}
      </div>
      <Drawer
        title="文件管理器"
